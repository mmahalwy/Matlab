...
function dataMatrix = finalexp10(filename) %to run this all you need to do is type demoExperiment('filename')
...
while doneExp == 0;
    ...
    elseif BWcondition ==1
        ...
        if theColor==1
            %present in red
            Screen('TextSize', window , 50);
            Screen('DrawText',window, sprintf('%s', cell2mat(theWord)), 600,400, [255 0 0])
            Screen('Flip', window);
        elseif theColor==2
            %present in blue
            Screen('TextSize', window , 50);
            Screen('DrawText',window, sprintf('%s', cell2mat(theWord)), 600,400, [51 102 255])
            Screen('Flip', window);
        elseif theColor==3
            %present in green
            Screen('TextSize', window , 50);
            Screen('DrawText',window, sprintf('%s', cell2mat(theWord)), 600,400, [0 205 0])
            Screen('Flip', window);
        end
